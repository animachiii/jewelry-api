...
| 17 | AWS Deployment (App Runner) | Client-mandated move off Render's free tier. ECR + App Runner, replacing Render as primary while keeping it and Fly as fallback paths, per `docs/decisions/0003-deploy-to-aws.md`. | Sequential after 16 | No | `phase-17-aws-deployment.md` | Not started |

**Recommended order:** 0 → 1 → 2 → (3 ‖ 4) → 6 → 7 → 8 → (9 ‖ 10 ‖ 11) → 12 → 13 → 14 → 16 → 17
